...
//麻将SIZE设置
#define MJ_BOTTOM_W     75          //下方麻将宽度
#define MJ_BOTTOM_H     109          //下方麻将高度

#define MJ_RIGHT_W      20
#define MJ_RIGHT_H      48
...
#define ATUO_WIN_GAME   0
#define ATUO_QGANG_HU_GAME       1
...
namespace ErMahjong
{
    ...
    struct MJGameEndData{
        ...
        std::vector<BYTE> cbZhongZaCardData;  //中扎码牌数据
