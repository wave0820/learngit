...
#include "../../SoundUtil/SoundRecordUtil.h"
...
namespace ErMahjong
{
	...
	public:
		...
		virtual void showUserReady(BYTE seatNo,bool boy,bool visible) override;
        virtual void playUserReadyEffect(bool isBoy)override;
        ...
        virtual void changePlayerScore(LLONG  i64TotalScore[GAME_PLAYER])override;
        ...
        virtual void playerBackGame(BackGameData data ,std::map<BYTE , std::vector<BYTE>> cbDusCardMaps ,std::map<BYTE , std::vector<BYTE>> cbHandCardsMaps,std::map<BYTE , std::vector<CMD_WeaveItem>> cbWeaveItemMaps) override;

        virtual void playerBackGameFreeState(std::string pwd , int zmCount) override;
        ...
        virtual void showGameBanker(BYTE seatNo , BYTE bankerCard , BYTE bankerAciton , BYTE actionCard,bool _bankerFourHZ) override;
        void setGameBanker(BYTE seatNo);  //设置游戏的庄家
        ...
        virtual void showUserChatTalkMsg(int type , BYTE seatNo, std::string msg) override;
        ...
        virtual void showGameAllRecord(GameRecordData data,bool isShow) override;
        
        virtual void onGameDisConnected()override;
        
        virtual void updateDeskOwnerId(int userId) override;
        
        void showUserOffLine(BYTE seatNo , bool offLine)override;
        ...
        void systemInfoChange(int type,int value);
    ...
    protected:
        ...
        void btnSelcetLanguageEventCallback(cocos2d::Ref* pSender, ui::Widget::TouchEventType touchtype);
        ...
        void changeLastCardCount(int count);
        
        void onShareCallBack(cocos2d::Ref* pSender, ui::Widget::TouchEventType touchtype);
        
        void changeRoomUIByPlayCount(int nowGameCount);
        
        void movePlayerSeatPoint();
        
		void doPlayUserVoice(Voice voice);
		
        void userWant2DisbandRoom(bool isShow);
        
        void updateChatBarProgress(float time);
    private:
        ...
        ImageView* _leftPanel;
        EditBox* _editChatMsg;
        ImageView * _imgNetState;
        LoadingBar * _batteryLevel;
        ...
        BYTE _caiShenCard;
        BYTE _bankerFourHZ;
        BYTE _bankerFirstAction;
        BYTE _bankerFirstActionCard;
        BYTE _curGameBanker;
        ...
        Text* label_time;
        Text* _roomInfoCardCountTxt;
        bool _isLastGame;
        int m_iNowGameCount;
        int m_iMaxGameCount;
        
        Layer* socketErrorLayer;
    ...
    private:
        ...
        bool _isPlayVoice;
        bool _gameStart;
        bool _isVoiceRecordingTimeEnd;
        bool _canRecording;
        std::vector< Map<std::string , Text *> > gameRecordTextMap;
        std::vector<ImageView *> gameRecordOwner;
        std::vector<ImageView *> gameRecordWiner;
        std::vector<ImageView *> gameRecordHeadImg;
        std::vector<Voice> voicesList;
        
        SoundRecordUtil* soundUtil;
