...
public:
    ...
    void getWxinfoByIOS(std::string headUrl, std::string unionid, std::string nickname, int sex);
...
public:
    ...
    virtual void onHandleLoginMessage(bool result, MSG_GP_R_UPDATE_URL* pLogonResult,UINT dwErrorCode) override;
    ...
    bool showRegisterSelector( YZSocketMessage* socketMessage );
