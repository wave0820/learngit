...
public:
    ...
    int uploadFile2ServerByFtp(std::string fileName , std::function<void(std::string fileName)> uploadCallBack);
    
    void downloadFile2LocalByFtp(std::string fileName ,std::function<void(std::string fileName)> downloadCallBack);
