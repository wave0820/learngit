...
void YZPlatformEventLayer::platformLogin(const std::string& name, const std::string& password, UINT uNameID,const std::string szUID ,const std::string hearUrl, const std::string sex , INT userId)
{
    //ss
