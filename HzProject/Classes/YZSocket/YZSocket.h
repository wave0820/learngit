...
#define TCP_CONNECT_ADDRERROR   -3
...
namespace YZ {
    ...
    public:
        ...
        static std::vector<std::string> getIpV6Address(const char *host);
    ...
    private:
        /*!
         * 判断是否ipv6（added by tonnyshen 20160613)
         */
        bool isIpv6(const char *domain="www.baidu.com");
