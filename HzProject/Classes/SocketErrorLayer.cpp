...
bool SocketErrorLayer::init()
{
    ...
    auto bg = (ImageView*)(Helper::seekWidgetByName(uiSocketErrorLayer,"BG"));
    bg->loadTexture("Loading/MjLoadingBg.png");
    ...
    auto btn_close = (Button*)(Helper::seekWidgetByName(uiSocketErrorLayer,"reLogin"));
	btn_close->addTouchEventListener(CC_CALLBACK_2(SocketErrorLayer::onBtnClicked,this));
    btn_close->setPositionX(uiSocketErrorLayer->getContentSize().width/2);
