...
static NSString *kAPP_NAME = @"欢腾红中麻将";
static NSString *kAPP_ID = @"wx2a97e8568ab10276";
static NSString *kMCH_ID = @"1379573502";
static NSString *kAPP_SECRET = @"8734a4c6d4c609b8aa422eee0fcf5e99";
static NSString *kAPI_KEY = @"jingjing88888888jingjing88888888";

static NSString *kShareLinkURL = @"https://a.mlinks.cc/AcAZ";
