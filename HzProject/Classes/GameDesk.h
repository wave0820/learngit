...
public:
    ...
    //创建房间消息
    virtual void onCreateBackRoomMessage(MSG_BACKROOM_INFO * data, BYTE bHandleCode) override;
    //查询房间消息
...
private:
    ...
    bool boardCastMsgSelector( YZSocketMessage* socketMessage );
